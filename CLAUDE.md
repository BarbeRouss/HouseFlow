...
- `claude` déclenche un agent Claude Code sur GitHub Actions (`.github/workflows/claude-issue.yml`) :
  il reproduit le bug, corrige, passe la checklist et ouvre la PR. Le label se pose à la main,
  après relecture de l'issue — jamais automatiquement
