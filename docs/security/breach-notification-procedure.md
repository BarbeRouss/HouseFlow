...
**Règle de disponibilité.** Le responsable de l'incident et le référent vie privée étant la même personne, un **délai de contact maximal de 24 heures** est retenu comme hypothèse de dimensionnement. Si un incident est signalé un vendredi soir, la notification à 72 heures reste tenable — mais sans marge. **Décision du 2026-09-23 : il n'y a pas de suppléant** — l'éditeur est une structure à une seule personne. La conséquence doit être assumée explicitement : en cas d'indisponibilité, le délai de 72 heures reste opposable. La mesure compensatoire est la **notification par phases** prévue à l'Art. 33(4) — notifier l'APD dans les 72 heures avec les éléments connus, même incomplets, et compléter ensuite, plutôt que d'attendre une investigation achevée. Cette option doit être privilégiée dès qu'un doute existe sur la disponibilité.
